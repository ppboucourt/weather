package com.pp.weather;

import com.pp.weather.config.ApplicationProperties;
import com.pp.weather.config.DefaultProfileUtil;
...
public class WeatherApp {
    ...
    public WeatherApp(Environment env) {
        this.env = env;
    }
